...
namespace DuneBuggyGame
{
    class MenuOptions
    {
        ...
        public void DrawOptions(SpriteBatch spriteBatch)
        {
            ...
            {
                case 0:
                    spriteBatch.Draw(optionsSoundsOff, new Rectangle(10, 250, 350, 85), Color.Red);
                    spriteBatch.Draw(optionsSoundsOn, new Rectangle(10, 300, 350, 85), Color.White);
                    break;
                case 1:
                    spriteBatch.Draw(optionsSoundsOff, new Rectangle(10, 250, 350, 85), Color.White);
                    spriteBatch.Draw(optionsSoundsOn, new Rectangle(10, 300, 350, 85), Color.Red);
                    break;
            }
            spriteBatch.End();
        }
